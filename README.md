...
The goal of this project is to be able to use AI in a local-only set up with minimal resources on very specific data
sets (in this case, the Django or Laravel documentation).
